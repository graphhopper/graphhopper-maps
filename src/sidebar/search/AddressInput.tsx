        ...
        new Geocoder(getApi(), (query, provider, hits) => {
            const items: AutocompleteItem[] = hits.map(hit => {
                ...
                return new GeocodingItem(
                    ...
                    obj.secondText,
                    hit.point,
                    hit.extent ? hit.extent : NavBar.getBBox(hit.point)
                )
            })
        ...
        (event: React.KeyboardEvent<HTMLInputElement>) => {
            ...
            switch (event.key) {
                ...
                case 'Tab':
                    ...
                    if (coordinate) {
                        props.onAddressSelected(text, coordinate, NavBar.getBBox(coordinate))
...
function onCurrentLocationSelected(
    ...
    navigator.geolocation.getCurrentPosition(
        position => {
            ...
            onSelect(tr('current_location'), coord, NavBar.getBBox(coord))
        },
        error => {
